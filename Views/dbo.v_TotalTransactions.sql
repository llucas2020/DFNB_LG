/*****************************************************************************************************************
NAME:    dbo.v_TotalTransactions
PURPOSE: Process for the creation of the views
MODIFICATION LOG:
Ver      Date        Author        Description
-----   ----------   -----------   -------------------------------------------------------------------------------
1.0     12/16/2020   LLUCAS2020      1. Created view dbo.v_TotalTransactions
...
/****** Object:  View [dbo].[v_TotalTransactions]    Script Date: 12/16/2020 2:47:36 PM ******/
DROP VIEW [dbo].[v_TotalTransactions]
GO
