...
3.0     12/16/2020   LLUCAS2020      3. Added enhancements for LDSBC IT 240 - Project 2.5: DFNB - Evaluate Current Performance - Data analysis views
4.0     12/16/2020   LLUCAS2020      4. Added Version 2 enhancements for LDSBC IT 240 - Project 3.6: DFNB - Predict and Prescribe Future Performance
...
USE [DFNB2]
GO
/****** Object:  View [dbo].[v_AccountCurBal]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  View [dbo].[v_AccountDim]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[v_AccountLoan]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GROUP BY YEAR(open_date)
GO
/****** Object:  View [dbo].[v_CustomerperArea]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[v_CustomerperRegion]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[v_FutureByArea]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
, YEAR(a.open_date))
GO
/****** Object:  View [dbo].[v_FutureByBranch]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SELECT a.branch_id AS 'Branch ID'
 ...
 GROUP BY a.branch_id
        ...
        , YEAR(a.open_date))
GO
/****** Object:  View [dbo].[v_FutureByRegion]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE VIEW [dbo].[v_FutureByRegion] AS (
 ...
 GROUP BY b.acct_region_id
        , YEAR(a.open_date));
GO
/****** Object:  View [dbo].[v_OpenCloseCode]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[v_TopBranchByLoan]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
group by branch_id
GO
/****** Object:  View [dbo].[v_TopBranchPerCust]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
Group by branch_id
GO
/****** Object:  View [dbo].[v_TopOldestCust]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
from tblcustomerdim
GO
/****** Object:  View [dbo].[v_TopOldestCustAge]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
from tblcustomerdim
GO
/****** Object:  View [dbo].[v_TopOldestCustMale]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where gender = 'm'
GO
/****** Object:  View [dbo].[v_TotalFeeAmount]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[v_TotalTransactions]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GROUP BY b.acct_branch_desc;
GO
/****** Object:  View [dbo].[v_TransactionCustomer]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[v_TransactionFees]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[v_TransactionType]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GROUP BY tt.tran_type_desc;
GO
/****** Object:  View [dbo].[v_TransactionYear]    Script Date: 12/18/2020 12:00:13 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
